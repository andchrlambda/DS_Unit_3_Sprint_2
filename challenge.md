...
- What is a situation where a document store (like MongoDB) is appropriate, and
  ...
  #Andrea's answer
  MongoDB is a NoSQL database, and it is appropriate to store large numbers of documents, or any collection of heterogenous data. A situation where this might
  be appropriate is a large news archive. The disadvantage of using a NoSQL
  system is that it is not ACID (Atomicity, Consistency,
  Isolation, Durability) compliant.

- What is "NewSQL", and what is it trying to achieve?
The aim of NewSQL is to achieve the best of SQL and NoSQL. It is looking to handle
the volume of NoSQL with the relational capability and ACID guaranteed of SQL.
NewSQL solutions have been explored since 2011. SQL has been around since 1970
and was adopted as an ANSI standard in 1986.
